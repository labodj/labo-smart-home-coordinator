/**
 * @file Tracks pending distributed-click transactions.
 *
 * The coordinator uses a request/ack/confirm flow for long-click actions. This
 * manager owns the small amount of correlation state needed to make that flow
 * deterministic, expire late confirmations, and replace stale attempts for the
 * same logical button slot.
 */
import type { PendingClickTransaction, Actor } from "./types";

/**
 * Stores pending network-click transactions until they are confirmed or expire.
 */
