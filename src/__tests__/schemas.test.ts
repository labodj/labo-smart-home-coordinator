...
describe("schemas", () => {
  ...
  it("enforces exact actuator targeting semantics for actors", () => {
    const missingActuatorListValid = validators.validateSystemConfig({
      devices: [
        {
          name: "sender",
          longClickButtons: [
            {
              id: 1,
              actors: [{ name: "actor-1", allActuators: false }],
            },
          ],
        },
        { name: "actor-1" },
    ...
    const duplicateActuatorsValid = validators.validateSystemConfig({
      devices: [
        {
          name: "sender",
          longClickButtons: [
            {
              id: 1,
              actors: [{ name: "actor-1", allActuators: false, actuators: [1, 1] }],
            },
          ],
        },
        { name: "actor-1" },
    ...
    const allActuatorsWithListValid = validators.validateSystemConfig({
      devices: [
        {
          name: "sender",
          longClickButtons: [
            {
              id: 1,
              actors: [{ name: "actor-1", allActuators: true, actuators: [1] }],
            },
          ],
        },
        { name: "actor-1" },
    ...
    const explicitSingleActuatorValid = validators.validateSystemConfig({
      devices: [
        {
          name: "sender",
          longClickButtons: [
            {
              id: 1,
              actors: [{ name: "actor-1", allActuators: false, actuators: [1] }],
            },
          ],
        },
        { name: "actor-1" },
    ...
    expect(missingActuatorListValid).toBe(false);
    expect(duplicateActuatorsValid).toBe(false);
    expect(allActuatorsWithListValid).toBe(false);
    expect(explicitSingleActuatorValid).toBe(true);
  });
