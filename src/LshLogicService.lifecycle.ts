/**
 * @file Lifecycle helper functions shared by the LSH logic service.
 *
 * These helpers keep reachability classification and configuration sanity checks
 * small, pure and easy to test. The service imports them instead of duplicating
 * the same bridge/controller recovery rules in startup, watchdog and reload
 * paths.
 */
